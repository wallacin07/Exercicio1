...
int main(){
	...
	if(totalsexom == 0){ //por causa a media nao pode ser dividida por 0, esse if eh pra isso
		totalsexom = 1;
	}
	if(totalsexof == 0){
		totalsexof = 1;
		...
		printf("\nTotal do sexo feminio e maior que 21 é de: %d pessoas.\n",totalsexof21);
		printf("\nTotal do sexo masculino e maior que 18 é de: %d pessoas. \n",totalsexom18);
		printf("\nMedia de idade do sexo feminio é de: %.2f anos.\n",mediaf);
		printf("\nMedia de idade do sexo masculino é de: %.2f anos.\n\n\n",mediam);
